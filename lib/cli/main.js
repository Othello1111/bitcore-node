...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .option('-c, --config <dir>', 'Specify the directory with Bcore Node configuration')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `bcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ bcore-node add wallet-service');
      console.log('    $ bcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ bcore-node remove wallet-service');
      console.log('    $ bcore-node remove insight-api');
      console.log();
    });
