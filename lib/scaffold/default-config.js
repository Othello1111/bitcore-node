...
/**
 * Will return the path and default bcore-node configuration. It will search for the
 * configuration file in the "~/.clashic" directory, and if it doesn't exist, it will create one
...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.clashic');
  var defaultConfigFile = path.resolve(defaultPath, './bcore-node.json');
